...
public class buscar extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    out.println("<html>");
    out.println("<head><title>buscar</title></head>");
    ...
    try {
      ...
      PreparedStatement sql = conexao.prepareStatement("select * from artigos where conteudo like ? ");
      ...
      resultado.beforeFirst(); //volta para o começo do arquivo
      ...
      while (resultado.next()){
        ...
        out.println("<td>"+ resultado.getString("conteudo").replaceAll(palavra,"<b>"+palavra+"</b>")+"</td>");
