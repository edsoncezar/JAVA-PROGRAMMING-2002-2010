...
public class texto extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    String s="Tecnoponta";
    out.println("<br>maiuscula: "+s.toUpperCase());//tudo em maiúscula
    out.println("<br>minuscula: "+s.toLowerCase());//tudo em minúscula
    out.println("<br>sub:"+s.substring(5,10));//pega um pedaço de uma string
