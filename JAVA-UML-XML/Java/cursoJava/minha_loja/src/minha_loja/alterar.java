...
public class alterar extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      ...
      PreparedStatement sql = conexao.prepareStatement("update produtos set descricao=?,prateleira=?,preco=?,fabricante=? where codigo=?");
      ...
      sql.setString(5,request.getParameter("codigo"));
      sql.executeUpdate();
