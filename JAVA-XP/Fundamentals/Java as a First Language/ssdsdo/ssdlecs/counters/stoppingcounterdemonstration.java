...
package counters;
 ...
 public class StoppingCounterDemonstration extends Object { 
 
    public static void main( String argv[]) { 
 
    StoppingCounter  aCounter = null; 
        ...
        aCounter = new StoppingCounter( 10, 12);      
        ...
        System.out.print( "demonstrating numberCountedIs() again,\n ");
        System.out.print( "it should stay at 12 ... ");
        aCounter.count();
        System.out.println(  aCounter.numberCountedIs());     
...
} // end class StoppingCounterDemonstration.    
