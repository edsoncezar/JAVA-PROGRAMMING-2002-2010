 ...
 *   java com.titan.clients.Client_122b <customerID> <cruiseID> <cabinID> <price>
 * 
 */

public class Client_122b {

	public static void main(String [] args) throws Exception {


		if (args.length != 4) {
			System.out.println("Usage: java com.titan.clients.Client_122b <customerID> <cruiseID> <cabinID> <price>");
			System.exit(-1);
		}
