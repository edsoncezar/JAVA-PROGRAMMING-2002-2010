...
<p><h3> 
<font color="red"> 
<%=messages.getString("CartAdded1")%> <i><%=book.getTitle()%></i>
...
<p><strong><a href="<%=request.getContextPath()%>/showcart">
<%=messages.getString("CartCheck")%></a>&nbsp;&nbsp;&nbsp;
<a href="<%=request.getContextPath()%>/cashier"><%=messages.getString("Buy")%></a>
</p></strong>
...
<td bgcolor="#ffffaa" rowspan=2> 
<a href="<%=request.getContextPath()%>/catalog?Add=<%=bookId%>">&nbsp;
