...
<jsp:useBean id="directory_two" scope="application" 
...
<%
  ...
  if ((name != null) && (!name.equals(""))) {
    ...
    String phone= directory_two.getProperty(name.trim());
    if (phone == null) 
  ...
  if ((newname != null) && (!newname.equals(""))) {
    String str = newname.trim() +"@" + 
                 request.getParameter("new_tel").trim();
    session.putValue("DO_INSERT",str);
...
%>
    ...
    <table width="100%" border="1" cellspacing="0" 
      ...
      <% Enumeration enum = directory_two.propertyNames();
         while(enum.hasMoreElements()) {
           String propname= (String)enum.nextElement();
           out.println("<tr> <td><b>" + propname+ "</b></td><td>" +
                       directory_two.getProperty(propname) + " </td></tr>");
         }
      %>
