...
<jsp:useBean id="directory" scope="application" class="java.util.Properties"/>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#CCCCFF" bordercolor="#000000">
  <tr>
	        <td>
...
<%  	
      ...
      // This servlet checks for a parameter called 'name' ie the name to lookup 
      // Or checks for the partemeter 'insert' which contains the enrty to insert
   ...
   // if the above returns have not been processed then just list the directory
   ...
   <table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#CCCCFF" bordercolor="#000000">
   	<tr> 
   		<td> <h3>Name</h3> </td><td> <h3>Phone number</h3> </td>
   	</tr>
   	
   	<% Enumeration enum = directory.propertyNames();
   		while(enum.hasMoreElements()){
   			String propname= (String)enum.nextElement();
   			out.println("<tr> <td><b>" + propname+ "</b></td><td>" +directory.getProperty(propname) +" </td></tr>");
   			}
   	%>		
