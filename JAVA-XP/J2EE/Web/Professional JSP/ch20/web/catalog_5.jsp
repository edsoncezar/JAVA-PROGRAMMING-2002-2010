...
<html>
  <head>
    ...
    <link rel="stylesheet" media="all" title="Default Styles" href="/ch20/widget.css">
  </head>
  <body>
  ...
  <table class="catalog_table" cellspacing="1" cellpadding="4">
    ...
    <jsp:useBean id="localWidgets" 
               class="com.wrox.projsp.ch20.WidgetDataPool" scope="request"/>
