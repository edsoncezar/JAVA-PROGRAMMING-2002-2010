  ...
  <TD>
    <TABLE BORDER=0 CELLPADDING=4 CELLSPACING=0 WIDTH=100%>
      <TR class="fieldlabel">
         ...
         <TD VALIGN="MIDDLE" ALIGN="LEFT" width="35%"><bean:write name="accountSummaryView" property="accountType"/></TD>

              <%-- Write out a hyperlink to view account detail --%>
              <TD VALIGN="MIDDLE" ALIGN="RIGHT" width="65%">
                <a href="action/getaccountdetail?id=<bean:write name="accountSummaryView" property="accountId"/>" class="navlink"><bean:message key="link.viewaccountdetail"/></a>
              </TD>
