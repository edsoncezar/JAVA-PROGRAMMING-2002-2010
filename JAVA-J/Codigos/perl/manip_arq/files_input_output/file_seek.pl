...
Seek.pm - A Perl module providing fast access to large files
...
This module provides fast access to data from large files. Three methods 
numeric() alphabetic() and find_time() depend on the file data 
...
=head2 The two basic methods - numeric() and alphabetic()
...
=head2 Return values with search success and failure
...
=head2 Adding line munging to make the basic methods more useful
...
=head2 Getting lines from the middle of a file  - get_between()
...
=head2 Getting the lines from the beginning of a file - get_between()
...
=head2 Getting lines from the end of a file - get_between()
...
=head2 Getting lines from the end of a file - get_last()
...
=head2 File::Seek::set_descending() File::Seek::set_ascending()
...
=head2 File::Seek::set_max_tries($max)
...
=head2 File::Seek::set_line_length($integer)
...
=head2 File::Seek::set_silent()  File::Seek::set_verbose()

You can silence or activate error messages by calling these two subs. The 
default is verbose.

=head2 File::Seek::set_debug()  File::Seek::no_debug()
