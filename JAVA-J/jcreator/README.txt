JCreator Pro Release V2.00 build 008
...
code completion, debugger interface, syntax highlighting, 
wizards and a fully customizable user interface. 

JCreator is written entirely in C++, which makes it a fast 
...
Unzip the installation file JCreatorSetup.exe in a 
...
JCreator Pro is Shareware. See enclosed EULA file.
